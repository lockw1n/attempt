...
#
#   scripts/test-optimized.sh [package-path ...]     # default: Packages/Persistence
#
...
# same tests in under a second. Only Persistence today, because it is the one package that
# fetches; a package that gains a `ModelContext` fetch belongs on the default list below.
#

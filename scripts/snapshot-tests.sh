...
#   ExerciseLibrary: 20 tests, all twenty reference-backed, no probes -> 20, its own count.
#   Logging:         15 tests, all fifteen reference-backed, no probes -> 15, its own count.
...
SUITES=(
    ...
    "Packages/Features/ExerciseLibrary|ExerciseLibrary|ExerciseLibrarySnapshotTests|20"
    "Packages/Features/Logging|Logging|LoggingSnapshotTests|15"
)

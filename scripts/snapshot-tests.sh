...
#   Logging:         48 tests, 47 reference-backed, one width probe    -> 48, above the 47.
#   History:          7 tests, all of them reference-backed, no probes  -> 7, its own count.
...
SUITES=(
    ...
    "Packages/Features/Logging|Logging|LoggingSnapshotTests|48"

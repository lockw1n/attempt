...
/// ``RepositoryInterface/WorkoutRepository``, ``RepositoryInterface/ExerciseRepository`` and
/// ``RepositoryInterface/SettingsRepository``, `SessionListView` names ``AppNavigation/Route`` and
/// the token scales, and `SessionSummary` names ``PowerliftingCore/Weight``. See

...
/// aliases until a screen used them for real. `ExerciseListState` now names ``RepositoryInterface/ExerciseRepository``,
/// `ExerciseListView` names ``AppNavigation/Route`` and the token scales, and both name the domain's

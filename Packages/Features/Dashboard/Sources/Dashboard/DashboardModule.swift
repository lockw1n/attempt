...
/// rule: `RecentRecordsView` names ``RepositoryInterface/ExerciseRepository``,
/// ``AppNavigation/Route`` and the token scales for real, so the scaffolding that stood in for a
/// screen has nothing left to prove.
